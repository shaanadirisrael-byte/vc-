...
export const botConfig = {
  ...
  commands: {
    ...
    // Do not delete slash commands automatically
...
export function getPrefixCommands() {
  return botConfig.commands?.prefixCommands ?? {};
}

export function getVCSubcommands() {
  return (
    botConfig.commands?.prefixCommands?.vc ?? {}
  );
}

export function isValidVCSubcommand(subcommand) {
  return Object.prototype.hasOwnProperty.call(
    getVCSubcommands(),
    String(subcommand || "").toLowerCase()
  );
}
